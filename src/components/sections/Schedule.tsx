...
export default async function Schedule() {
  ...
  return (
    <section
      id="schedule"
      className="lg:scroll-mt-21 md:scroll-mt-18 scroll-mt-16 flex justify-center my-20"
    >
      <div className="container-80 flex flex-col gap-10">
        <Animated duration={1.5} distance={100} delay={0.1}>
          <h2 className="md:text-6xl text-5xl font-bold text-center">Ближайшие игры</h2>
        </Animated>
